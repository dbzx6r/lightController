// ──────────────────────────────────────────────────────────────────
//  HueDial – ESP8266 Philips Hue Room Controller
...
static void clampScroll() {
    ...
    int visRows = (240 - 22) / 36; // VISIBLE_ROWS from display.cpp
...
void loop() {
    ...
    // ── ROOM DETAIL ──────────────────────────
        ...
        // Send debounced brightness to HA
        ...
        // Periodic HA poll to sync external changes
